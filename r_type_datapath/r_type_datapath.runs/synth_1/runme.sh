...
HD_PWD='C:/Users/ADMIN/Vivado_project/r_type_datapath/r_type_datapath.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log r_type_datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source r_type_datapath.tcl
